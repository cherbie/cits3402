 ...
 */
int read_to_coo_async(COO **sparse_mtx, int k, int fid) {
    ...
    else if(!read_coo_filef(sparse_mtx, k, fid)) return 0;
 ...
 * @return 1 to indicate success and 0 to indicate failure.
 */
int read_coo_filef_async(COO **coo_mtx, int k, int fid) {
    int rows, cols;
    float val = 0.0;
    rows = 0, cols = 0;
 ...
 * @return 1 to indicate success and 0 to indicate failure.
 */
int read_coo_filei_async(COO **coo_mtx, int k, int fid) {
    int rows, cols, val;
    rows = 0, cols = 0; val = 0;
    (*coo_mtx)[k].size = 0; //no elements
 ...
 */
int add_int_coo_async(COO *coo_mtx, int val, int row, int col, long int index) {
 ...
 * @count is the array index of the coordinates.
 */
int add_float_coo_async(COO *coo_mtx, float val, int row, int col, long int index) {
 ...
 */
int read_to_csr_async(CSR **sparse_mtx, int k, int fid) {
 ...
 */
int coo2csr_async(COO *coo_mtx, CSR *csr_mtx) {
...
int read_to_csc_async(CSC **sparse_mtx, int k, int fid) {
    COO *coo_mtx = malloc(1 * sizeof(COO));
    if(!read_to_coo(&coo_mtx, k, fid)) {
        fprintf(stderr, "Error reading into sparse matrix.\n");
        return 0;
 ...
 */
int coo2csc_async(COO *coo_mtx, CSC *csc_mtx) {
